...
@section('content')
    <div class="content-header">
                            <div class="header-section">
                                ...
                                <form action="{{ route('postcategories.update', ['id' => $post_category->id])}}" method="post" class="form-inline">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                                <div class="form-group">
                                    <label class="sr-only" for="post_category"></label>
                                    <input type="text" id="post_category" name="post_category" class="form-control" value="{{ $post_category->name }}">
                                </div>
                                            ...
                                            <td class="text-center">{{$post_category->name}}</a></td>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        ...
                                                        <form action="" class="btn btn-xs btn-danger" method="post">
