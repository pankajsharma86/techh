                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="block">
                                    ...
                                    <form action="{{ route('productsubcategories.store') }}" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                       ...
                                       <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="product_sub_category_name" name="product_sub_category_name" class="form-control" placeholder="Enter first level category name..">
                                            </div>
                                        </div>
                                       <div class="form-group">
