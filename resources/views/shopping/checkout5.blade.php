        ...
        <div id="content">
            <div class="container">
                ...
                <div class="col-md-9" id="checkout">
                    ...
                    <div class="box">
                        <form method="post" action="{{ route('cart.checkout.cash')}}">
                                    ...
                                    @endforeach
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                ...
                                                <th>${{ (number_format(Cart::total()))*0.034+0.45}}</th>
                                            </tr>
                                            <tr>

                                                <th colspan="5">Total</th>
                                                
                                                <th><input class="w3-input w3-border" style="width:130px" id="amount" type="text" value="{{(number_format(Cart::total()))+(number_format(Cart::total()))*1.15-(number_format(Cart::total())) }}" readonly name="amount"></th>
                                            </tr>
                                        </tfoot>
